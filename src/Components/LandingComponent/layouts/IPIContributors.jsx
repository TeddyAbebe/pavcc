            ...
            <div className="features-four__left" style={{ background: "#f0f3f8" }}>
              ...
              <div className="features-four__left-bottom">
                <p className="features-four__left-text">
                  ...
                  <br />
                  By becoming a member of the IPI through the Pan Africa Venture Capital
                  Platform, individuals can contribute to a fund designed to empower
                  entrepreneurs while ensuring their financial contributions are safeguarded.
                </p>
                    ...
                    <li className="features-four__right-single" style={{ paddingBottom: '0rem' }}>
                      <div className="features-four__right-single-inner">
                        ...
                        <div className="title" style={{ marginBottom: '-4rem' }}>
                          ...
                          <p>
                            Membership in the IPI also fosters a sense of community among
                            like-minded individuals who are passionate about supporting entrepreneurship.
                          </p>
                        </div>
                      </div>
                    </li>
