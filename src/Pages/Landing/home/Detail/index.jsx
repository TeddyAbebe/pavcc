...
import MembershipCard from "../../../Ventura/Dashboard/MembershipCard";
...
export const HomeDetail = () => {
  ...
  const fetchIdeasById = async () => {
    try {
      const response = await axios.get(
        `${back_base_url}/api/v1/ent/entrepreneurs/freeusers/${id}`,
        {}
      );
  ...
  const handleRegisterPremium = () => {
    window.location.href = "/register/vc";
  };
            ...
            {isDisplay === 1 && (
              <div className="mt-4 p-1 flex flex-col items-start gap-2">
                ...
                <p className="mb-2 text-sm">
                  {ideaById?.yearsInBusiness} years
                </p>
